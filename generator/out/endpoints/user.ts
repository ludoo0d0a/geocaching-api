...
export const userMethodsApi = (configuration: InternalConfiguration, httpClient: HttpClient): UserMethodsApi => {
  ...
  /**
    ...
    */
  const getUsers = (params: GetUsers, cb): Users => {
  ...
  /**
    ...
    */
  const getUserLogs = (params: GetUserLogs, cb): GeocacheLogs => {
    // check required params
  ...
  /**
    ...
    */
  const getLists = (params: GetLists, cb): Lists => {
    // check required params
  ...
  /**
    ...
    * @restrictions Users may opt out of sharing personal data. See
    */
  const getSouvenirs = (params: GetSouvenirs, cb): Souvenirs => {
    // check required params
  ...
  /**
    ...
    * @restrictions Users may opt out of sharing personal data. See
    */
  const getUserImages = (params: GetUserImages, cb): Images => {
    // check required params
  ...
  /**
    ...
    * @restrictions Users may opt out of sharing personal data. See
    */
  const getGeocacheFavoritedby = (params: GetGeocacheFavoritedby, cb): Users => {
    // check required params
