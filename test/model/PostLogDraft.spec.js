...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeocachingApiV10.PostLogDraft();
  });
  ...
  describe('PostLogDraft', function() {
    it('should create an instance of PostLogDraft', function() {
      // uncomment below and update the code to test PostLogDraft
      //var instance = new GeocachingApiV10.PostLogDraft();
      //expect(instance).to.be.a(GeocachingApiV10.PostLogDraft);
    });
