...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeocachingApiV10.ListGeocache();
  });
  ...
  describe('ListGeocache', function() {
    it('should create an instance of ListGeocache', function() {
      // uncomment below and update the code to test ListGeocache
      //var instance = new GeocachingApiV10.ListGeocache();
      //expect(instance).to.be.a(GeocachingApiV10.ListGeocache);
    });

    it('should have the property listItemName (base name: "listItemName")', function() {
      // uncomment below and update the code to test the property listItemName
      //var instance = new GeocachingApiV10.ListGeocache();
