...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AttributeType', 'model/Country', 'model/GeocacheLogType', 'model/GeocacheType', 'model/MembershipLevel', 'model/State', 'model/TrackableLogType'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AttributeType'), require('../model/Country'), require('../model/GeocacheLogType'), require('../model/GeocacheType'), require('../model/MembershipLevel'), require('../model/State'), require('../model/TrackableLogType'));
  } else {
    // Browser globals (root is window)
    if (!root.GeocachingApiV10) {
      root.GeocachingApiV10 = {};
    }
    root.GeocachingApiV10.ReferenceDataApi = factory(root.GeocachingApiV10.ApiClient, root.GeocachingApiV10.AttributeType, root.GeocachingApiV10.Country, root.GeocachingApiV10.GeocacheLogType, root.GeocachingApiV10.GeocacheType, root.GeocachingApiV10.MembershipLevel, root.GeocachingApiV10.State, root.GeocachingApiV10.TrackableLogType);
  }
}(this, function(ApiClient, AttributeType, Country, GeocacheLogType, GeocacheType, MembershipLevel, State, TrackableLogType) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.referenceDataGetAttributes = function(apiVersion, callback) {
      var postBody = null;
     ...
     */
    this.referenceDataGetCountries = function(apiVersion, callback) {
      var postBody = null;
     ...
     */
    this.referenceDataGetGeocacheLogTypes = function(apiVersion, callback) {
      var postBody = null;
     ...
     */
    this.referenceDataGetGeocacheTypes = function(apiVersion, callback) {
      var postBody = null;
     ...
     */
    this.referenceDataGetMembershipLevels = function(apiVersion, callback) {
      var postBody = null;
     ...
     */
    this.referenceDataGetStates = function(apiVersion, callback) {
      var postBody = null;
     ...
     * data is of type: {@link Array.<module:model/State>}
     */
    this.referenceDataGetStatesByCountry = function(countryId, apiVersion, callback) {
      var postBody = null;
     ...
     */
    this.referenceDataGetTrackableLogTypes = function(apiVersion, callback) {
      var postBody = null;
