...
(function(root, factory) {
  ...
  describe('Trackable', function() {
    ...
    it('should have the property kilometersTraveled (base name: "kilometersTraveled")', function() {
      // uncomment below and update the code to test the property kilometersTraveled
      //var instane = new ApiV10.Trackable();
      //expect(instance).to.be();
    });

    it('should have the property milesTraveled (base name: "milesTraveled")', function() {
      // uncomment below and update the code to test the property milesTraveled
      //var instane = new ApiV10.Trackable();
      //expect(instance).to.be();
    });
