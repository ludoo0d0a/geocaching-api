...
GeocachingApi.prototype.setAuth = function(params, cb)
{
    _.assign(this.config, params);
    
    //You can pass credentials, if you get it (Used for mocha tests)
    ...
    if (!this.strategy){
        this.strategy = new GeocachingStrategy(this.config, this._verify);
    }
};
