 ...
 */
export const trackableMethodsApi = (
  ...
  /**
    ...
    */
  const getGeocacheTrackables = (params: GetGeocacheTrackables, cb): Trackables => {
  ...
  /**
    ...
    * @restrictions 
    */
  const getUsersTrackables = (params: GetUsersTrackables, cb): Trackables => {
  ...
  /**
    ...
    * @restrictions 
    */
  const getTrackableImages = (params: GetTrackableImages, cb): Images => {
    // check required params
  ...
  /**
    ...
    * @restrictions 
    */
  const getGeocoinTypes = (params: GetGeocoinTypes, cb): Types => {
